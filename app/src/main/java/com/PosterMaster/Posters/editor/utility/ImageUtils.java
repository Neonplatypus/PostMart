package com.PosterMaster.Posters.editor.utility;
...
import com.PosterMaster.Posters.editor.utils.ExifUtils;
...
public class ImageUtils {
    ...
    public static Bitmap getResampleImageBitmap(Uri uri, Context context, int i) throws IOException {
        try {
            return com.PosterMaster.Posters.editor.utils.ImageUtils.getInstant().getCompressedBitmap(getRealPathFromURI(uri, context));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
